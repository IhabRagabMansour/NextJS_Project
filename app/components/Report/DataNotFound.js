function DataNotFound({ msg }) {
  return (
    <div className="fixed z-20 bg-white w-full h-full top-0 left-0 flex flex-col items-center justify-center">
      <svg
        className="w-32 h-32 text-gray-200 dark:text-gray-600 fill-blue-400 m-4"
        version="1.1"
      ...
      <h1 className="font-bold p-2 mt-2">Sorry, no data found.</h1>
      <p>{msg}</p>
    </div>
  );
}
